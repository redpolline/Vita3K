...
EXPORT(int, sceIoRemove, const char *path) {
    ...
    return remove_file(emuenv.io, path, emuenv.get_wide_pref_path(), export_name);
}
...
EXPORT(int, sceIoRename, const char *oldname, const char *newname) {
    ...
    return rename(emuenv.io, oldname, newname, emuenv.get_wide_pref_path(), export_name);
}
...
EXPORT(int, sceIoRmdir, const char *path) {
    ...
    return remove_dir(emuenv.io, path, emuenv.get_wide_pref_path(), export_name);
}
