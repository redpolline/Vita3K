...
void dump(const SceGxmTexture &gxm_texture, const MemState &mem, const std::string &parameter_name, const std::string &cache_path, const std::string &title_id, Sha256Hash program_hash) {
    ...
    const fs::path texturelog_path{ fs::path(cache_path) / "texturelog" / title_id };
